...
// Login screen component with email sign-in
      ...
      <div className="max-w-md w-full text-center">
          ...
          <>
            ...
            <div className="relative my-6">
              ...
              <div className="relative flex justify-center text-xs">
                <span className="px-3 bg-[#0D0D2A] text-[#676986]">or</span>
              </div>
            </div>
          </>
        )}
        ...
        <form onSubmit={handleEmailSignIn} className="space-y-4 text-left">
          <input
            ...
            className="w-full px-4 py-4 bg-[#1a1a3e] border border-white/10 rounded-xl text-white placeholder-[#676986] focus:outline-none focus:border-[#e3f98a]/50 focus:ring-1 focus:ring-[#e3f98a]/50 transition-all"
            required
          />
